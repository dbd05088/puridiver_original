...
args.robust_type = "CoTeaching" # none, SELFIE, CoTeaching, DivideMix, PuriDivER
args.mem_manage = "RM" # RSV, GBS, RM, PuriDivER
...
args.n = 50
args.m = 10
args.noisy_percent = 20
args_text = build_command_line_args(args)
command = f'CUDA_VISIBLE_DEVICES=2 nohup python main.py {args_text} &'
