...
args.robust_type = "none" # none, SELFIE, CoTeaching, DivideMix, PuriDivER
args.mem_manage = "PuriDivER" # RSV, GBS, RM, PuriDivER
args.dataset = "cifar100" # cifar10, cifar100, WebVision-V1-2, Food-101N
...
args.n = 50
args.m = 10
args.noisy_percent = 60
args_text = build_command_line_args(args)
command = f'CUDA_VISIBLE_DEVICES=4 nohup python main.py {args_text} &'
